...
additionalCuts = { 
    #high R9 EB cat0
    0 : 'ph_full5x5x_r9 > 0.85', 
    1 : 'ph_full5x5x_r9 > 0.85', 
    2 : 'ph_full5x5x_r9 > 0.85', 
    3 : 'ph_full5x5x_r9 > 0.85', 
    4 : 'ph_full5x5x_r9 > 0.85', 
    5 : 'ph_full5x5x_r9 > 0.85', 
...
tnpParAltSigFit_addGaus = [
    ...
    # "meanP[-0.0,-5.0,5.0]","sigmaP[0.5,0.1,5.0]",
    # "meanF[-0.0,-5.0,5.0]","sigmaF[0.5,0.1,5.0]",
    # "acmsP[60.,50.,100.]","betaP[0.05,0.01,0.09]","gammaP[0.1, 0, 1]","peakP[90.0]",
    # "acmsF[60.,50.,100.]","betaF[0.05,0.01,0.09]","gammaF[0.1, 0, 1]","peakF[90.0]",
    # "gmeanF[80, 65, 90]",
    # "gsigmaF[8, 1, 12]",
    # "gmeanP[80, 65, 90]",
    # "gsigmaP[8, 1, 12]",
    ...
    # "meanP[-0.0,-5.0,5.0]","sigmaP[0.5,0.1,5.0]",
    # "meanF[-0.0,-5.0,5.0]","sigmaF[0.5,0.1,5.0]",
    # "acmsP[60.,50.,130.]","betaP[0.05,0.01,0.09]","gammaP[0.1, 0, 1]","peakP[90.0]",
    ...
    "meanP[-0.0,-5.0,5.0]","sigmaP[0.5,0.1,5.0]",
    "meanF[-0.0,-5.0,5.0]","sigmaF[0.5,0.1,5.0]",
    "acmsP[103.,50.,130.]","betaP[0.05,0.01,0.08]","gammaP[0.1, 0, 1]","peakP[90.0]",
    "acmsF[80.,50.,120.]","betaF[0.05,0.01,0.06]","gammaF[0.1, 0, 1]","peakF[90.0]",
    "gmeanF[80, 65, 90]",
    "gsigmaF[8, 1, 12]",
    "gmeanP[80, 65, 90]",
    "gsigmaP[8, 1, 12]",
...
tnpParAltBkgFit = [
    ...
    # "meanF[-0.0,-5.0,5.0]","sigmaF[0.5,0.1,0.6]",
    # "alphaP[0.,-2.,1.]",
    # "alphaF[0.,-2 .,1.]",
    # "gmeanF[80, 65, 90]",
    # "gsigmaF[8, 1, 15]", 
    ...
    # "meanF[-0.0,-2.0,2.0]","sigmaF[0.5,0.1,5.0]",
    # "alphaP[0.,-2.,1.]",
    # "alphaF[0.,-2 .,1 .]",
    # "gmeanF[80, 65, 90]",
    # "gsigmaF[8, 1, 11]", 
    ...
    #bin 0!
    "meanP[-0.0,-5.0,5.0]","sigmaP[0.5,0.1,1.6]",
    "meanF[-0.0,-5.0,5.0]","sigmaF[0.5,0.1,0.7]",
    "alphaP[0.,-2.,1.]",
    "alphaF[0.,-2 .,1 .]",
    "gmeanF[80, 65, 90]",
    "gsigmaF[8, 1, 12]", 
    ...
    #bin 0?
    # "meanP[-0.0,-5.0,5.0]","sigmaP[0.5,0.1,2.0]",
    # "meanF[-0.0,-5.0,5.0]","sigmaF[0.5,0.1,1.0]",
    # "alphaP[0.,-2.,1.]",
    # "alphaF[0.,-2 .,1 .]",
    # "gmeanF[80, 65, 90]",
    # "gsigmaF[8, 1, 15]", 
    ...
    # "meanP[-0.0,-5.0,5.0]","sigmaP[0.5,0.1,3.0]",
    # "meanF[-0.0,-5.0,5.0]","sigmaF[0.5,0.1,0.8]",
    # "alphaP[0.,-2.,1.]",
    # "alphaF[0.,-2 .,1 .]",
    # "gmeanF[80, 65, 90]",
    # "gsigmaF[8, 1, 15]", 
...
#     "gsigmaP[8, 1, 15]",
 ...
 # "meanP[-0.0,-5.0,5.0]","sigmaP[0.5,0.1,1.]",
 #    "meanF[-0.0,-5.0,5.0]","sigmaF[0.5,0.1,0.7]",
 #    "alphaP[0.,-2.,1.]",
 #    "alphaF[0.,-2 .,1 .]",
 #    "gmeanF[80, 65, 90]",
